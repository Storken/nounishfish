export const contractABI = [
  {
    inputs: [
      ...
      { internalType: 'uint8', name: '_maxTokensPerTxn', type: 'uint8' },
      { internalType: 'uint256', name: '_reservedTokens', type: 'uint256' }
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_tokenPrice1', type: 'uint256' },
      { internalType: 'uint256', name: '_tokenPrice2', type: 'uint256' }
    ],
    name: 'setMintPrice',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'bool', name: '_publicSaleIsActive', type: 'bool' }
    ],
    name: 'setPublicSale',
    outputs: [],
    stateMutability: 'nonpayable',
